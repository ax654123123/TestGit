...
@interface RiLiViewController () <DSLCalendarViewDelegate>
...
- (void)calendarView:(DSLCalendarView *)calendarView didSelectRange:(DSLCalendarRange *)range {
    if (range != nil) { 
        ...
        if (range.startDay.day == range.endDay.day && range.startDay.month == range.endDay.month) {
            [self.delegate dianjitilipush:[range.startDay date]];
        }
    }
    else {
        NSLog( @"No selection" );
